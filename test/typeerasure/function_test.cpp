...
TEST(FunctionTest, Function8_freeFunctionIntsByValue)
{
    ...
    EXPECT_EQ(42, Function8(addIntsByValue).invoke(std::vector<cpp::SimpleAny8>{20, 22}).get<int>());
}
...
TEST(FunctionTest, Function32_freeFunctionStringsByConstReference)
{
    ...
    EXPECT_EQ("hello, world!", Function32(addStringsByConstReference).invoke(std::vector<cpp::SimpleAny32>{"hello, "s, "world!"s}).get<std::string>());
}

TEST(FunctionTest, Function16_memberFunctionIntsByValue)
{
    EXPECT_EQ(42, Function16(&Class::addIntsByValue)(Class(), 20, 22).get<int>());
    EXPECT_EQ(42, Function16(&Class::addIntsByValue).invoke(std::vector<cpp::SimpleAny16>{Class(), 20, 22}).get<int>());
}
...
TEST(FunctionTest, Function32_memberFunctionStringsByConstReference)
{
    ...
    EXPECT_EQ("hello, world!", Function32(&Class::addStringsByConstReference).invoke(std::vector<cpp::SimpleAny32>{Class(), "hello, "s, "world!"s}).get<std::string>());
}
...
TEST(FunctionTest, Function16_constMemberFunctionIntsByValue)
{
    ...
    EXPECT_EQ(42, Function16(&Class::addIntsByValueConst).invoke(std::vector<cpp::SimpleAny16>{Class(), 20, 22}).get<int>());
}
...
TEST(FunctionTest, Function32_constMemberFunctionStringsByConstReference)
{
    ...
    EXPECT_EQ("hello, world!", Function32(&Class::addStringsByConstReferenceConst).invoke(std::vector<cpp::SimpleAny32>{Class(), "hello, "s, "world!"s}).get<std::string>());
}
